...
//           dx: (Math.random() < 0.5 ? -1 : 1) * (1.2 + Math.random() * 1.2), // moderate speed
//           dy: (Math.random() < 0.5 ? -1 : 1) * (1.2 + Math.random() * 1.2),
//         }))
//     }
...
//   // --- Ensure animate-blob keyframes are present ---
//   // This is a fallback for environments where global CSS is missing
//   // (You can remove this if you guarantee animate-blob is in your CSS)
//   useEffect(() => {
...
//     <div
//       ref={containerRef}
//       className={`relative h-screen w-full overflow-hidden bg-gray-50 dark:bg-gray-950 ${className}`}
//     >
//       {/* Glowing Blobs - high opacity, strong blur, vibrant colors */}
//       <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-[1] pointer-events-none">
//         <div className="absolute top-[15%] left-[8%] w-[38rem] h-[38rem] bg-pink-400/60 dark:bg-pink-500/40 rounded-full blur-[100px] animate-blob"></div>
//         <div className="absolute top-[45%] left-[55%] w-[32rem] h-[32rem] bg-blue-400/50 dark:bg-blue-500/30 rounded-full blur-[90px] animate-blob animation-delay-2000"></div>
//         <div className="absolute bottom-[12%] right-[18%] w-[36rem] h-[36rem] bg-purple-500/50 dark:bg-purple-500/30 rounded-full blur-[110px] animate-blob animation-delay-4000"></div>
//         <div className="absolute bottom-[28%] left-[32%] w-[30rem] h-[30rem] bg-emerald-400/40 dark:bg-emerald-400/20 rounded-full blur-[80px] animate-blob animation-delay-3000"></div>
//       </div>
//       {/* Bouncing SVGs */}
...
// const SVG_SHAPES = [
//   // ... (unchanged SVGs)
//   // Keep your SVG_SHAPES array as it is but update SVG_SIZE = 72
// ]
