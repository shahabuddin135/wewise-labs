...
//   // Always autoplay, even if user interacts or section is not in view
//   useEffect(() => {
...
//       ref={ref}
//     >
//       <BgGlowBouncingSVGs className="-z-10 blur-xl inset-[5vh] sm:inset-[3vh]" />
...
//             >
//               <p className="text-xl md:text-2xl mb-8 text-gray-700 dark:text-gray-300 italic">"{t.testimonial}"</p>
