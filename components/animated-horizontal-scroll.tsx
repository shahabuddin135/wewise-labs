...
export default function AnimatedHorizontalScroll({ className = "" }: AnimatedHorizontalScrollProps) {
    ...
    try {
      ...
      textElements.forEach((element, index) => {
        ...
        gsapInstance.to(el, {
          ...
          scrollTrigger: {
            trigger: el,
            ...(mainScrollTween ? { containerAnimation: mainScrollTween } : {}),
            start: "left 90%",
            end: "left 10%",
  ...
  // 1. If mobile/tablet, render a simple horizontal scroll (no GSAP, no animation)
  if (isMobileOrTablet) {
    return (
      <div
        className={`relative h-[110dvh] overflow-x-auto overflow-y-hidden bg-white dark:bg-gray-950 ${className}`}
      ...
      >
        ...
        <div className="flex items-center h-full whitespace-nowrap px-8" style={{ minWidth: "max-content" }}>
          {/* At */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-600 dark:from-sky-300 dark:via-blue-400 dark:to-indigo-500 bg-clip-text text-transparent ml-10 mr-8 md:mr-16">
            At
          </span>
          ...
          {/* wewise */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 dark:from-pink-400 dark:via-purple-400 dark:to-blue-400 bg-clip-text text-transparent mr-8 md:mr-16">
            wewise,
          </span>
          ...
          {/* we */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-lime-400 via-green-500 to-emerald-600 dark:from-lime-300 dark:via-green-400 dark:to-emerald-500 bg-clip-text text-transparent mr-8 md:mr-16">
            we
          </span>
          ...
          {/* mean */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 dark:from-yellow-400 dark:via-orange-400 dark:to-red-400 bg-clip-text text-transparent mr-8 md:mr-16">
            mean
          </span>
          ...
          {/* it */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-amber-400 via-orange-500 to-red-600 dark:from-amber-300 dark:via-orange-400 dark:to-red-500 bg-clip-text text-transparent mr-8 md:mr-16">
            it
          </span>
          ...
          {/* when */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-green-500 via-blue-500 to-purple-500 dark:from-green-400 dark:via-blue-400 dark:to-purple-400 bg-clip-text text-transparent mr-8 md:mr-16">
            when
          </span>
          ...
          {/* we */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-violet-500 via-purple-500 to-fuchsia-600 dark:from-violet-300 dark:via-purple-400 dark:to-fuchsia-500 bg-clip-text text-transparent mr-8 md:mr-16">
            we
          </span>

          {/* say: */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-cyan-500 via-teal-500 to-green-500 dark:from-cyan-400 dark:via-teal-400 dark:to-green-400 bg-clip-text text-transparent mr-8 md:mr-16">
            say:
          </span>

          {/* "Creative */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-rose-400 via-pink-500 to-red-600 dark:from-rose-300 dark:via-pink-400 dark:to-red-500 bg-clip-text text-transparent mr-8 md:mr-16">
            &quot;Creative
          </span>

          {/* we */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-pink-500 via-red-500 to-orange-500 dark:from-pink-400 dark:via-red-400 dark:to-orange-400 bg-clip-text text-transparent mr-8 md:mr-16">
            we
          </span>

          {/* are!" */}
          <span className="text-[7rem] md:text-[10rem] lg:text-[12rem] font-bold bg-gradient-to-r from-teal-400 via-cyan-500 to-sky-500 dark:from-teal-300 dark:via-cyan-400 dark:to-sky-500 bg-clip-text text-transparent mr-56 md:pr-16">
            are!&quot;
          </span>
          {/* Spacer to ensure last text is fully visible on sm screens only */}
          <div className="inline-block" style={{ width: "160vw" }} aria-hidden="true"></div>
        </div>
      </div>
    )
  }

  // 2. Otherwise, render the animated version (current code)
  return (
    <div
      ref={containerRef}
