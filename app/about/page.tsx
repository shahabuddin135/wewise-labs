        ...
        <MaskContainer
          revealText={
            ...
            <div className="flex flex-col items-center ">
              ...
              {/* <WhatWeDo/> */}
              <section>
                <div className="flex flex-col md:flex-row h-auto max-w-2xl md:max-w-4xl lg:max-w-7xl mt-9 mx-4 sm:mx-8 lg:mx-auto gap-8 pl-8   bg-gray-100 dark:bg-gray-950  dark:border-1 dark:border-white rounded-2xl justify-between">
                  <div className="flex justify-center items-center w-full md:w-1/2">
                    ...
                    <Image
                      ...
                      width={300}
                      height={300}
                      className="w-[400px] h-[400px] md:object-contain object-cover block dark:hidden"
                    />
                    {/* Dark mode image */}
                    <Image
                      ...
                      width={300}
                      height={300}
                      className="w-[] h-[] md:object-contain object-cover hidden dark:block"
                    />
                  </div>

                  <div className="flex flex-col gap-14 items-start p-8 md:p-6 md:w-1/2 m- text-center">
                    <h1 className="text-5xl sm:text-6xl md:text-6xl mt-5 font-libre text-center font-bold text-black dark:text-white">
                      What Do We Do?
                    </h1>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-libre font-bold text-black dark:text-white text-center md:text-left"> */}
              ...
              {/* <FoundingMembers/> */}
              <section>
                <div className="flex flex-col md:flex-row h-auto max-w-2xl md:max-w-4xl lg:max-w-7xl mt-9 mx-4 sm:mx-8 lg:mx-auto dark:bg-gray-950 rounded-2xl justify-between ">
